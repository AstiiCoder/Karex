...
uses
  ...
  AdvGlowButton, ExtCtrls, AdvPanel, cxGridDBTableView, cxGrid,
...
uses MainWindow, Dialog1, cxFilterConsts, Graphik;
...
begin
   try
     ...
     cxGrid1DBTableView1.Columns[cxGrid1DBTableView1.GetColumnByFieldName('NUMETIKETKI').Index].EditValue:='';
     //cxGrid1DBTableView1.Columns[cxGrid1DBTableView1.GetColumnByFieldName('ETIKETKADATE').Index].EditValue:='null';
     cxGrid1DBTableView1.Columns[cxGrid1DBTableView1.GetColumnByFieldName('NUMDOGOVOR').Index].EditValue:='';
     cxGrid1DBTableView1.Columns[cxGrid1DBTableView1.GetColumnByFieldName('NUMZAYAVKA').Index].EditValue:='';
     ...
     cxGrid1DBTableView1.Columns[cxGrid1DBTableView1.GetColumnByFieldName('PUNKTNAZNACH').Index].EditValue:=0;
...
begin
      ...
      if cxGrid1DBTableView1.Columns[cxGrid1DBTableView1.GetColumnByFieldName('VIDTRANSPORT').Index].EditValue<>'0' then s:=' '+LookUpText('VIDTRANSPORT');
      if cxGrid1DBTableView1.Columns[cxGrid1DBTableView1.GetColumnByFieldName('NAZVTRANSPORT').Index].EditValue<>'нет данных' then s:=s+': '+cxGrid1DBTableView1.Columns[cxGrid1DBTableView1.GetColumnByFieldName('NAZVTRANSPORT').Index].EditValue;
      ExcelApp.WorkBooks[1].WorkSheets[1].Cells[20, 6] :=LookUpText('PROISHOZHD')+' '+s;  //происх обр
